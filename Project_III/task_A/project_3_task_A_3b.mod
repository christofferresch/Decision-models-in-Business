...
minimum_senior_quantity:				# senior sales must be greater than minimum requirement
	S["r"] >= 0.1 * Cap;

minimum_student_quantity:				# student sales must be greater than minimum requirement
	S["s"] >= 0.1 * Cap;
