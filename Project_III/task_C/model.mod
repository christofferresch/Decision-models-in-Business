...
let datafile := "hour_task2A.dat"; # For task 2A
#let datafile := "hour_task2B.dat"; # For task 2B
#let datafile := "blockbids_2_task3.dat";
#let datafile := "blockbids_i.dat";   # Select the input data file here for question 3 (complete the data file name with 1,2,3,4,5)
